...
public class Config : IConfig
{
    ...
    public List<BotsList> BotsList { get; private set; } = new() { new BotsList() { BotName = "Dedicated Server", BotId = 99 }, new BotsList() { BotName = "Elevator Audio", BotId = 98 } };
    ...
    [Description("Enable ElevatorClip? (true = yes, false = no)")]
    public bool ElevatoClipStart { get; private set; } = false;
    public List<AudioFile> ElevatorClip { get; private set; } = new() { new AudioFile(), new AudioFile() { Path = System.IO.Path.Combine(Paths.Plugins, "audio", "test2.ogg") } };

...
public class Plugin : Plugin<Config>
{
    ...
    public override Version Version { get; } = new Version(2, 0, 9);
    ...
    public override void OnEnabled()
    {
        try
        {
            ...
            if (Config.Debug)
            {
                AudioEvents.AudioElevatorStart += handlers.OnAudioElevatorStart;
                AudioEvents.AudioElevatorUsed += handlers.OnAudioElevatorUsed;
                AudioEvents.AudioElevatorFinished += handlers.OnAudioElevatorFinished;
